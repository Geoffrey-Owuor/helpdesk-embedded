    ...
    <section className="flex h-full items-center justify-center overflow-hidden py-16">
      <div className="custom:px-8 w-full px-4">
        <div className="mx-auto max-w-3xl text-center">
          {/* Badge */}
          <div className="mb-8 inline-flex items-center gap-2 rounded-full bg-neutral-50 px-3 py-1 text-xs text-neutral-600 dark:bg-neutral-900/50 dark:text-neutral-400">
            <span
