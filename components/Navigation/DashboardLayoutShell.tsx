...
const DashboardLayoutShell = ({ children }: { children: React.ReactNode }) => {
  ...
  const defaultContent = (
    <HydrationGuard>
      ...
      <div
        id="main-content"
        className={`layout-scrollbar fixed top-14 right-0 bottom-0 left-0 scrollbar-gutter-stable overflow-y-auto rounded-3xl border border-[#eceef1] bg-white transition-all duration-200 ease-in-out lg:right-2 lg:bottom-2 lg:rounded-2xl ${showSidebar ? "lg:left-20" : "lg:left-2"} dark:border-neutral-900 dark:bg-black`}
      >
