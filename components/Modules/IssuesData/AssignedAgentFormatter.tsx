...
import { Headset, UserRoundX } from "lucide-react";
...
export const AssignedAgentFormatter = ({
  ...
  return (
    <div
      className={`inline-flex items-center gap-1.5 rounded-full bg-neutral-100 px-2 py-1 text-xs font-semibold transition-colors dark:bg-neutral-800 ${
        isUnassigned
    ...
    >
      {isUnassigned ? (
        ...
        <Headset className="h-3.5 w-3.5 text-neutral-500 dark:text-neutral-400" />
      )}
