        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="relative w-fit">
            ...
            <input
              ...
              className="w-60 rounded-full border border-neutral-300 bg-white py-3 pr-10 pl-11 text-sm text-neutral-900 placeholder-neutral-500 shadow-2xs focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:outline-none sm:w-80 dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-100 dark:placeholder-neutral-400 dark:focus:border-blue-400 dark:focus:ring-blue-400/20"
            />
            <button
