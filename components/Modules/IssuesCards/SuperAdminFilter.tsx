  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`relative inline-flex h-6 w-11 items-center rounded-lg transition-colors duration-200 ease-in-out focus-visible:ring-2 focus-visible:ring-neutral-500 focus-visible:ring-offset-2 focus-visible:ring-offset-white focus-visible:outline-none dark:focus-visible:ring-neutral-400 dark:focus-visible:ring-offset-neutral-900 ${
          enabled
      ...
      >
        {/* Sliding circle */}
        <span
          className={`absolute left-1 h-4 w-4 rounded-md shadow-md transition-transform duration-200 ease-in-out ${
            enabled
