...
import { AssignedAgentFormatter } from "@/components/Modules/IssuesData/AssignedAgentFormatter";
import RelativeTimeBadge from "@/components/Modules/IssuesData/RelativeTimeBadge";
import { ResolutionTimePill } from "@/components/Modules/IssuesData/ResolutionTimePill";
import { DetailCard } from "@/components/Modules/IssuePage/HelperComponents/DetailCard";
import { InfoBlock } from "@/components/Modules/IssuePage/HelperComponents/InfoBlock";
import IssueAttachmentsViewer from "@/components/Modules/IssueModals/IssueAttachmentsViewer";
import CommentsSection from "@/components/Modules/IssuePage/CommentsSection";
import { fetchAnalyticsIssueDetail } from "@/queries/analytics/fetchAnalyticsIssueDetail";
...
const AnalyticsIssueDetailPage = ({ uuid }: { uuid: string }) => {
  const {
    ...
    queryKey: ["analyticsIssueDetail", uuid],
    queryFn: () => fetchAnalyticsIssueDetail(uuid),
    retry: false,
  });
  ...
  return (
    <div className="mx-auto py-6 md:py-4">
      ...
      <div className="mb-4 flex flex-col justify-between gap-4 lg:flex-row lg:items-center">
        ...
        <div className="flex flex-col items-start gap-3 lg:items-end">
          <div className="flex flex-wrap items-center gap-2">
            <ReadOnlyHistoryButtons
              uuid={uuid}
              reopenedCount={Number(issueData.reopened_count)}
              escalatedCount={Number(issueData.escalated_count)}
            />
            <RelativeTimeBadge
      ...
      <div className="mb-6 grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-xl border border-neutral-200 bg-white p-6 shadow-xs dark:border-neutral-800 dark:bg-neutral-950">
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none">
            <p
              title={issueData.issue_description}
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <CommentsSection uuid={uuid} readOnly />
...
export default AnalyticsIssueDetailPage;
