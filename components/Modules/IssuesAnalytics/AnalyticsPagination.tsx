...
const AnalyticsPagination = ({ total }: { total: number }) => {
  const page = useAnalyticsFilterStore((state) => state.page);
  const pageSize = useAnalyticsFilterStore((state) => state.pageSize);
  const setPage = useAnalyticsFilterStore((state) => state.setPage);
  const setPageSize = useAnalyticsFilterStore((state) => state.setPageSize);
